...
####################### Banner #########################
banner:
  title : "让我们解决您关键的网站开发挑战"
  image : "images/banner-art.svg"
  content : "创建最佳战略工具，与您的团队共享，并通过直观的仪表板确保其正常运行。 足够简单，具有复杂性和灵活性，可满足大型企业的需求"
  button:
    enable : true
    label : "免费开始"
    link : "get-demo/"
...
feature:
  enable : true
  title : "用于创建、共享和执行的终极平台。"
  content : "我们正在帮助数以千计的组织实施其业务战略并实现其雄心勃勃的成果！ 我们制定大计划。"
  button:
    enable : true
    label : "免费试用"
    link : "get-demo/"
